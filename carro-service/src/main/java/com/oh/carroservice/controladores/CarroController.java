package com.oh.carroservice.controladores;


import com.oh.carroservice.entidades.Carro;
import com.oh.carroservice.servicios.CarroService;
...
public class CarroController {
    ...
    // Guardar un listado de Carros
    @PostMapping("/guardar-carros")
    public void guardarCarros(@RequestBody List<Carro> listacarros){
